...
import net.xelor.client.services.DataService;
import net.xelor.client.structures.energy.light.LightDataHandler;
import net.xelor.client.devices.DeviceManager;
import net.xelor.client.house.HouseManager;
import net.xelor.client.logger.LoggerProvider;
import net.xelor.client.weather.WeatherDataProvider;
...
public class XelorModule {
    ...
    private XelorModule() {
        ...
        weatherDataProvider = new WeatherDataProvider("-", "London", true);
