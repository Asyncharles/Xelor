...
public interface Searchable<T extends Number, V extends Number> {
     ...
     * This value is the primary value to store, that will be used by Xelor to determine a result depending on the {@link net.xelor.structures.targets.TargetValue}
     * @return {@link Number}
     */
     ...
     * This value is the secondary value to store, that will be used by Xelor correct and analyse the result calculated with the primary value and the {@link net.xelor.structures.targets.TargetValue}
     * @return {@link Number}
     */
