...
import net.xelor.query.SearchFilter;
...
public interface DataContainer<T extends Searchable> {
     ...
     *     The data is also assigned to {@link net.xelor.weather.WeatherData}
     ...
     *     Used mostly by the {@link net.xelor.engine.Engine} to calculate results depending from {@link net.xelor.structures.targets.TargetValue}
